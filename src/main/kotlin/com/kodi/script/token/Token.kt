...
enum class TokenType {
     ...
     */
    fun canEndStatement(): Boolean = this in setOf(
        IDENT, NUMBER, STRING, TRUE, FALSE, NULL, RPAREN, RBRACE
    )
    
    /**
     * Returns true if this token type indicates statement continuation.
     */
    fun isOperatorContinuation(): Boolean = this in setOf(
        PLUS, MINUS, ASTERISK, SLASH, AND, OR, EQ, NOT_EQ,
        LT, GT, LT_EQ, GT_EQ, SAFE_ACCESS, ELVIS, DOT, COMMA
    )
}
